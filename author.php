...
?>
	<main class="page-category" id="page_archive">
		<section class="section-block">
			<div class="container">
				<div class="heading">
					<h1 class="entry-title text-uppercase"><text>Read stories by -</text><br /> <?php the_archive_title(); ?></h1>
				</div>
			</div>
		</section>
							...
							<div class="meetup-card">
								<div class="thumbnail">
									<a href="<?php the_permalink(); ?>">
										<?php the_post_thumbnail('full', array('class' => 'thumb-story', 'alt' => esc_html($article_name) . ' image')); ?>
									</a>
								</div>
