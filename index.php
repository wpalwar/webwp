...
?>
	<main class="page-category" id="page_archive">
		<section class="section-block page-header">
			<div class="container">
				<div class="heading">
					<h1 class="entry-title text-uppercase">WordPress Alwar Meetup's</h1>
				</div>
			</div>
		</section>
							...
							<div class="meetup-card" >
								...
								<div class="article-content">
									<div class="content-text">
										<?php //echo (isset($categories[0])) ? wp_sprintf('<a href="%s" title="%s" class="terms-title text-uppercase">%s</a>', get_term_link($categories[0]), esc_html($categories[0]->name), esc_attr($categories[0]->name)) : ''; ?>
