...
?>
	<main class="page-category" id="page_archive">
		<section class="section-block page-header">
			<div class="container">
				<div class="heading">
					<h1 class="entry-title text-uppercase"><text>Search Results for -</text><br /><?php echo get_search_query(); ?></h1>
				</div>
			</div>
		</section>
							...
							<div class="meetup-card">
								<div class="thumbnail">
									<a href="<?php the_permalink(); ?>">
										<?php the_post_thumbnail('full', array('class' => 'thumb-story', 'alt' => $article_name)); ?>
									</a>
								</div>
				...
				<?php else : ?>
					<div class="row">
						<div class="no-search-result">
							<p><?php _e('Sorry, We can\'t find your search term. Please try again with a different keyword.', 'webwp'); ?></p>
							<?php get_search_form(); ?>
							<div class="field _full">
								<a class="webwp__btn--link contact-form-submit" href="<?php echo home_url('/stories'); ?>">Explore other stories</a>
							</div>
						</div>
					</div>
				<?php endif; ?>
